...
////////////////////////////////////////////////////////////////
//Module Architecture: fir_filter_mat
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b1111111101110010; //sfix16_En17
  parameter signed [15:0] coeff2 = 16'b1111111111101111; //sfix16_En17
  parameter signed [15:0] coeff3 = 16'b0000000011001001; //sfix16_En17
  parameter signed [15:0] coeff4 = 16'b0000001000000001; //sfix16_En17
  parameter signed [15:0] coeff5 = 16'b0000001011111110; //sfix16_En17
  parameter signed [15:0] coeff6 = 16'b0000001010001111; //sfix16_En17
  parameter signed [15:0] coeff7 = 16'b1111111110010011; //sfix16_En17
  parameter signed [15:0] coeff8 = 16'b1111101000001110; //sfix16_En17
  parameter signed [15:0] coeff9 = 16'b1111001111111111; //sfix16_En17
  parameter signed [15:0] coeff10 = 16'b1111000101000100; //sfix16_En17
  parameter signed [15:0] coeff11 = 16'b1111011001000101; //sfix16_En17
  parameter signed [15:0] coeff12 = 16'b0000010111001110; //sfix16_En17
  parameter signed [15:0] coeff13 = 16'b0001111100011110; //sfix16_En17
  parameter signed [15:0] coeff14 = 16'b0011110101000111; //sfix16_En17
  parameter signed [15:0] coeff15 = 16'b0101100001101010; //sfix16_En17
  parameter signed [15:0] coeff16 = 16'b0110100010000001; //sfix16_En17
  parameter signed [15:0] coeff17 = 16'b0110100010000001; //sfix16_En17
  parameter signed [15:0] coeff18 = 16'b0101100001101010; //sfix16_En17
  parameter signed [15:0] coeff19 = 16'b0011110101000111; //sfix16_En17
  parameter signed [15:0] coeff20 = 16'b0001111100011110; //sfix16_En17
  parameter signed [15:0] coeff21 = 16'b0000010111001110; //sfix16_En17
  parameter signed [15:0] coeff22 = 16'b1111011001000101; //sfix16_En17
  parameter signed [15:0] coeff23 = 16'b1111000101000100; //sfix16_En17
  parameter signed [15:0] coeff24 = 16'b1111001111111111; //sfix16_En17
  parameter signed [15:0] coeff25 = 16'b1111101000001110; //sfix16_En17
  parameter signed [15:0] coeff26 = 16'b1111111110010011; //sfix16_En17
  parameter signed [15:0] coeff27 = 16'b0000001010001111; //sfix16_En17
  parameter signed [15:0] coeff28 = 16'b0000001011111110; //sfix16_En17
  parameter signed [15:0] coeff29 = 16'b0000001000000001; //sfix16_En17
  parameter signed [15:0] coeff30 = 16'b0000000011001001; //sfix16_En17
  parameter signed [15:0] coeff31 = 16'b1111111111101111; //sfix16_En17
  parameter signed [15:0] coeff32 = 16'b1111111101110010; //sfix16_En17
  ...
  assign mul_temp = delay_pipeline[31] * coeff32;
  assign product32 = mul_temp[30:0];

  assign mul_temp_1 = delay_pipeline[30] * coeff31;
  assign product31 = mul_temp_1[30:0];

  assign mul_temp_2 = delay_pipeline[29] * coeff30;
  assign product30 = mul_temp_2[30:0];

  assign mul_temp_3 = delay_pipeline[28] * coeff29;
  assign product29 = mul_temp_3[30:0];

  assign mul_temp_4 = delay_pipeline[27] * coeff28;
  assign product28 = mul_temp_4[30:0];

  assign mul_temp_5 = delay_pipeline[26] * coeff27;
  assign product27 = mul_temp_5[30:0];

  assign mul_temp_6 = delay_pipeline[25] * coeff26;
  assign product26 = mul_temp_6[30:0];

  assign mul_temp_7 = delay_pipeline[24] * coeff25;
  assign product25 = mul_temp_7[30:0];

  assign mul_temp_8 = delay_pipeline[23] * coeff24;
  assign product24 = mul_temp_8[30:0];

  assign mul_temp_9 = delay_pipeline[22] * coeff23;
  assign product23 = mul_temp_9[30:0];

  assign mul_temp_10 = delay_pipeline[21] * coeff22;
  assign product22 = mul_temp_10[30:0];

  assign mul_temp_11 = delay_pipeline[20] * coeff21;
  assign product21 = mul_temp_11[30:0];

  assign mul_temp_12 = delay_pipeline[19] * coeff20;
  assign product20 = mul_temp_12[30:0];

  assign mul_temp_13 = delay_pipeline[18] * coeff19;
  assign product19 = mul_temp_13[30:0];

  assign mul_temp_14 = delay_pipeline[17] * coeff18;
  assign product18 = mul_temp_14[30:0];

  assign mul_temp_15 = delay_pipeline[16] * coeff17;
